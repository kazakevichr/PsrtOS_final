...
export async function POST(req: Request) {
  ...
  const slotHints: Record<string, string> = {
    make: "нарезка вирусного фитнес-видео: тема-акцент дня (упражнение, ошибка, миф)",
    carousel: "образовательная карусель: питание, БАДы, тренировки, восстановление — конкретная тема с фактурой",
    "trainer:female": "ролик тренера-девушки: практичный совет по тренировкам/питанию для женщин",
  };
