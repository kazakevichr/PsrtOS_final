...
export async function POST(req: Request) {
  ...
  const slotHints: Record<string, string> = {
    ...
    carousel: "пост с тренировками: подборка упражнений, готовая программа или разбор техники («5 упражнений на ягодицы дома», «Программа новичка на 3 дня», «Техника приседа: частые ошибки»). НЕ питание и НЕ БАДы",
